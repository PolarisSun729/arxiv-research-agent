...
for tool_spec in [
    ...
    _tool("request_confirmation", capability_tags=["clarify", "confirm"], input_schema={"pending_action": "dict"}, output_schema={"confirmation_status": "dict"}, side_effect_level="session_write", implementation="pending_action_node.classify_pending_action_confirmation"),
    ...
    _tool("retrieve_paper_chunks", capability_tags=["retrieve"], input_schema={"paper_reference": "dict", "query": "str"}, output_schema={"paper_chunks": "list"}, implementation="paper_qa.retrieve_chunks"),
    _tool("rewrite_paper_query", capability_tags=["rewrite", "retrieve"], input_schema={"message": "str"}, output_schema={"rewritten_query": "str"}, side_effect_level="session_write", implementation="paper_reading_node.rewrite_query"),
    _tool("rerank_paper_chunks", capability_tags=["rerank"], input_schema={"paper_chunks": "list"}, output_schema={"reranked_chunks": "list"}, implementation="paper_qa.rerank_chunks"),
    _tool("validate_qa_evidence", capability_tags=["validate"], input_schema={"reranked_chunks": "list"}, output_schema={"validated_evidence": "dict"}, implementation="paper_qa.validate_evidence"),
    _tool("generate_paper_answer", capability_tags=["answer"], input_schema={"validated_evidence": "dict", "query": "str"}, output_schema={"paper_answer": "dict"}, implementation="tools.answer_paper_question"),
    _tool("verify_answer_grounding", capability_tags=["validate", "answer"], input_schema={"paper_answer": "dict"}, output_schema={"final_answer": "str"}, implementation="paper_qa.verify_answer_grounding"),
    ...
    _tool("update_interest_profile", capability_tags=["memory_write", "profile"], input_schema={"preference_action_result": "dict"}, output_schema={"memory_update": "dict"}, side_effect_level="persistent_write", implementation="preference_node.update_interest_profile"),
    ...
    _tool("resolve_reading_list_action", capability_tags=["retrieve", "reading_list"], input_schema={"message": "str"}, output_schema={"reading_list_action": "dict"}, implementation="reading_list.resolve_action"),
    _tool("update_reading_list_store", capability_tags=["memory_write", "reading_list"], input_schema={"reading_list_action": "dict"}, output_schema={"reading_list_result": "dict"}, side_effect_level="persistent_write", implementation="reading_list.update_store"),
    _tool("verify_reading_list_update", capability_tags=["validate", "reading_list"], input_schema={"reading_list_result": "dict"}, output_schema={"verified_reading_list_update": "dict"}, implementation="reading_list.verify_update"),
    _tool("synthesize_reading_list_response", capability_tags=["answer", "reading_list"], input_schema={"verified_reading_list_update": "dict"}, output_schema={"final_answer": "str"}, implementation="response_node.synthesize_reading_list_response"),
