...
_LEGACY_OUTPUT_PROJECTION = {
    ...
    "paper_qa_result": ["status", "answer", "sources", "cited_source_ids", "citation_debug", "citation_warning", "retrieval_debug", "qa_observation", "error", "arxiv_id", "question", "tool_result"],
