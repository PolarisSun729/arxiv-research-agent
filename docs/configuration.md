...
- `RECOMMENDATION_PROFILE_POSITIVE_MIN_LIKED_FOR_VECTOR`
- `RECOMMENDATION_PROFILE_POSITIVE_MIN_LIKED_FOR_CLUSTERING`
- `RECOMMENDATION_PROFILE_POSITIVE_MAX_INTEREST_CLUSTERS`
- `RECOMMENDATION_PROFILE_NEGATIVE_ENABLED`
- `RECOMMENDATION_PROFILE_NEGATIVE_STORE_DISLIKED_EXAMPLES`
- `RECOMMENDATION_PROFILE_NEGATIVE_MIN_DISLIKED_FOR_INSTANCE_FEEDBACK`
- `RECOMMENDATION_PROFILE_NEGATIVE_MAX_DISLIKED_EXAMPLES`
- `RECOMMENDATION_PROFILE_NEGATIVE_ENABLE_NEGATIVE_CLUSTERING`
- `RECOMMENDATION_PROFILE_NEGATIVE_MIN_DISLIKED_FOR_CLUSTERING`
- `RECOMMENDATION_PROFILE_NEGATIVE_MAX_NEGATIVE_CLUSTERS`
- `RECOMMENDATION_PROFILE_NEGATIVE_FALLBACK_TO_EXAMPLES_WHEN_CLUSTER_FAILED`
- `RECOMMENDATION_RANKING_NEGATIVE_ENABLED`
- `RECOMMENDATION_RANKING_NEGATIVE_SIMILARITY_THRESHOLD`
- `RECOMMENDATION_RANKING_NEGATIVE_MARGIN`
- `RECOMMENDATION_RANKING_NEGATIVE_PENALTY_WEIGHT`
- `RECOMMENDATION_RANKING_NEGATIVE_CONFIDENCE_MIN_COUNT`
- `RECOMMENDATION_RANKING_NEGATIVE_MAX_PENALTY`
- `RECOMMENDATION_RANKING_NEGATIVE_USE_MARGIN_PENALTY`
- `RECOMMENDATION_RANKING_NEGATIVE_USE_THRESHOLD_PENALTY`
- `RECOMMENDATION_RANKING_NEGATIVE_ENABLE_HARD_FILTER`
- `RECOMMENDATION_RANKING_NEGATIVE_HARD_FILTER_THRESHOLD`
- `RECOMMENDATION_RANKING_NEGATIVE_DEBUG_ENABLED`

这些参数决定：

- 默认返回多少推荐结果
- 推荐候选的时间范围
- liked papers 达到多少才生成主正向兴趣向量
- liked papers 达到多少才聚类用户兴趣
- 最多保留多少兴趣簇
- disliked papers 是否作为独立负向反馈保存、何时启用实例级反馈、何时启用负向聚类，以及聚类失败是否退回实例级样本
- 排序阶段如何把负向相似度转换为扣分，包括阈值、margin、置信度、最大扣分和可选 hard filter
...
- `RECOMMENDATION_PROFILE_NEGATIVE_CLUSTERING_MIN_CLUSTER_SIZE`
- `RECOMMENDATION_PROFILE_NEGATIVE_CLUSTERING_MIN_SAMPLES`
- `RECOMMENDATION_PROFILE_NEGATIVE_CLUSTERING_METRIC`
...
- `RECOMMENDATION_SCORE_WEIGHT_DISLIKED_PENALTY`（兼容字段，已废弃；负向扣分改由 `RECOMMENDATION_RANKING_NEGATIVE_*` 控制）
