...
rem Double-click launcher for count-only arXiv OAI-PMH sync.
rem This counts matching papers without writing to SQLite or Milvus.
...
echo [%DATE% %TIME%] Running arXiv OAI-PMH count-only sync from !FROM_DATE! to !UNTIL_DATE!
